...
// RUN: %clangxx -fsycl -fpreview-major-release -fsyntax-only -ferror-limit=0 -Xclang -verify -Xclang -verify-ignore-unexpected=note,warning,error %s -DPREVIEW_MAJOR_RELEASE
...
// -fpreview-major-release option. Remove the use of this option when this
