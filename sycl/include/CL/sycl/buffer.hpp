...
public:
  ...
  buffer(const range<dimensions> &bufferRange,
    ...
    impl->recordBufferUsage(((void*)this), SizeInBytes, 0, sizeof(T), false );
  }
  ...
  buffer(buffer<T, dimensions, AllocatorT> &b, const id<dimensions> &baseIndex,
    ...
    impl->recordBufferUsage(((void*)this), get_size(), this->OffsetInBytes, sizeof(T), this->IsSubBuffer );
  }
  ...
  buffer(cl_mem MemObject, const context &SyclContext,
    ...
    impl = std::make_shared<detail::buffer_impl>(
        ...
        make_unique_ptr<detail::SYCLMemObjAllocatorHolder<AllocatorT>>(),
        AvailableEvent);
    impl->recordBufferUsage(((void*)this), BufSize, 0, sizeof(T), false );
  }
