/*
  ...
  clang++ -fsycl  -o vsu_1d_w_test.exe vulkan_sycl_unsampled_1d_write.cpp -Wno-ignored-attributes -lvulkan-1 -I$VULKAN_SDK/Include -L$VULKAN_SDK/Lib
  

    ./vsu_1d_w_test.bin 
    ./vsu_1d_w_test.bin --semaphores
    FLAGS
